...
export function AdminLayout() {
  return (
    <SidebarProvider>
      <AdminSidebar />
      <SidebarInset>
        <header className="sticky top-0 z-20 flex h-14 shrink-0 items-center gap-2 bg-card/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-card/80">
        ...
        <div className="flex-1 bg-card px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
